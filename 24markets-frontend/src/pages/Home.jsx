...
//         <h1>24Markets - Trade Anytime, Anywhere</h1>
//         <p>Real-time trading platform with live market data</p>
...
//         <h2>Why Choose 24Markets?</h2>
//         <div className="feature-cards">
//           <div className="card">
//             <h3>Real-time Data</h3>
//             <p>Get live market updates with Redis caching</p>
//           </div>
//           <div className="card">
//             <h3>Secure Trading</h3>
//             <p>Advanced security with Spring Boot backend</p>
//           </div>
//           <div className="card">
//             <h3>Fast Performance</h3>
//             <p>Optimized database queries with MySQL</p>
//           </div>
//         </div>
//       </section>
//     </div>
